...
class CashInvoicessView extends StatelessWidget {
  const CashInvoicessView({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          GetInvoicsessCubit(InvoicsessRepoIm())..getInvoicess(type: 1),
      child: Column(
        children: [
              ...
              return CustomTextFormFiald(
                  onChanged: (value) {
                    BlocProvider.of<GetInvoicsessCubit>(context)
                        .searchClintInvoice(type: 1, name: value!);
                  },
